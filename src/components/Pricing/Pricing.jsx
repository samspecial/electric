...
const Pricing = ({ planType, description, amount, benefits, buttonText  }) => {
    return (<PriceCard>
...
&:hover{
    ...
    box-shadow:0px 4px 8px rgba(0,0,0,0.25),0px 4px 8px rgba(0,0,0,0.20),0px 4px 8px rgba(0,0,0,0.18),0px 4px 8px rgba(0,0,0,0.25),0px 4px 8px rgba(0,0,0,0.25);
}
